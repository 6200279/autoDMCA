/**
 * Firefox Background Script for Content Protection Extension
 * Adapted for Firefox WebExtensions (Manifest V2)
 */
...
class FirefoxBackgroundService {
  ...
  setupContextMenus() {
    // Create context menu items for Firefox
  ...
  setupEventListeners() {
    ...
    // Handle browser action click (Firefox uses browserAction)
  ...
  // Copy all methods from the Chrome version with Firefox-specific API calls
...
// Initialize Firefox background service
new FirefoxBackgroundService();